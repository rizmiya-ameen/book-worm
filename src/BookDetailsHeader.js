...
function BookDetailsHeader ({handleMyShelf, book, title, authors, publishedDate, publisher, pageCount, saleInfo, isEbook, industryIdentifiers, favorite, handleFavorite, toReadBooks, imageUrl}) {
